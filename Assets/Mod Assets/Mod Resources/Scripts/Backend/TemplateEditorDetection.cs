...
public class TemplateEditorDetection : Editor {
    ...
    static TemplateEditorDetection() {
        ...
        var ntdotjsx = System.Type.GetType("ntdotjsx.Core.Simulation", false);
        ...
        var ntdotjsxDefine = "UNITY_TEMPLATE_NTDOTJSX";
        ...
        if (ntdotjsx != null && !allDefineSymbols.Contains(ntdotjsxDefine)) { allDefineSymbols.Add(ntdotjsxDefine); }
